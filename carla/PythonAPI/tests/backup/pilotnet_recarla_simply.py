...
class HUD(object):
    def __init__(self, width, height):
        ...
        myfonts = ['lato', 'tlwgtypo', 'dejavuserif', 'urwbookman', 'kalapi', 'rekha', 'tlwgtypewriter', 'dejavusansmono', 'ubuntumono', 'rachana', 'liberationmono', 'pottisreeramulu', 'anjalioldlipi', 'suravaram', 'notoserifcjksc', 'keraleeyam', 'garuda', 'nimbusmonops', 'notosansmono', 'notoserifcjktc', 'freesans', 'p052', 'liberationsansnarrow', 'kacstfarsi', 'padaukbook', 'dejavusans', 'nimbussans', 'rasa', 'liberationsans', 'nimbussansnarrow', 'padmaa', 'notoserifcjkjp', 'notoserifcjkhk', 'notoserifcjkkr', 'freeserif', 'c059', 'uroob', 'yrsa', 'mrykacstqurn', 'tlwgtypist', 'peddana', 'kacstone', 'freemono', 'gayathri', 'notosanscjkjp', 'notosanscjkhk', 'notosanscjkkr', 'loma', 'liberationserif', 'padauk', 'kacstdigital', 'ubuntu', 'kacstpen', 'ponnala', 'notosanscjksc', 'laksaman', 'chilanka', 'notosanscjktc', 'kinnari', 'lohitgurmukhi', 'tlwgmono', 'ramaraja', 'mitra', 'waree', 'sarai', 'manjari', 'umpush', 'z003', 'urwgothic', 'sawasdee', 'lohitbengali', 'kacstscreen', 'kacstart', 'saab', 'samyaktamil', 'lohitgujarati', 'd050000l', 'lohitassamese', 'timmana', 'raviprakash', 'norasi', 'purisa', 'nimbusroman', 'khmeros', 'opensymbol', 'gidugu', 'lohitdevanagari', 'kalimati', 'droidsansfallback', 'khmerossystem', 'lohittelugu', 'ramabhadra', 'nats', 'lohitodia', 'karumbi', 'phetsarathot', 'kacstdecorative', 'lklug', 'ani', 'lakkireddy', 'lohittamilclassical', 'tenaliramakrishna', 'jamrul', 'pagul', 'lohittamil', 'likhan', 'samyakdevanagari', 'gurajada', 'notosansmonocjktc', 'syamalaramana', 'lohitmalayalam', 'notosansmonocjksc', 'notosansmonocjkkr', 'notosansmonocjkhk', 'sreekrushnadevaraya', 'notosansmonocjkjp', 'kacsttitlel', 'navilu', 'ubuntucondensed', 'tibetanmachineuni', 'kacstletter', 'standardsymbolsps', 'ori1uni', 'raghumalayalamsans', 'aakar', 'notomono', 'mukti', 'suranna', 'lohitkannada', 'dyuthi', 'meera', 'dhurjati', 'pothana2000', 'mandali', 'gubbi', 'mallanna', 'gargi', 'notocoloremoji', 'samyakgujarati', 'chandas', 'kacstbook', 'kacstposter', 'padmaabold11', 'sahadeva', 'kacstqurn', 'kacstnaskh', 'ntr', 'nakula', 'samanata', 'vemana2000', 'suruma', 'kacsttitle', 'samyakmalayalam', 'kacstoffice', 'abyssinicasil']
        fonts = [x for x in myfonts if 'mono' in x]
...
def game_loop(args):
    ...
    try:
        ...
        world = World(client.load_world('Town03_Opt'), hud, args)
        ...
        while True:
            ...
            if type(world.camera_manager.image).__module__ == np.__name__:
                ...
                if (frame_time > 12) and (frame_time < 12.5): # Right turn
                    break
                """if (frame_time > 17.9) and (frame_time < 18.1): # Left turn
                    break"""
